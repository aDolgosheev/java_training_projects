...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        user2.sendMessage(user1, "I am user2. Nice to meet you, user1!");
        ...
        user1.sendMessage(user3, "So nice to see you agein.");
        ...
        System.out.println(MessageDatabase.getMessages().get(3));
    }
}
